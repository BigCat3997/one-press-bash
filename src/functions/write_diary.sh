...
GLOBAL_ENV_VAR_MANAGER_SCRIPT_PATH="${SCRIPTS_WORK_DIR}/global_env_var_manager.sh"
...
./${GLOBAL_ENV_VAR_MANAGER_SCRIPT_PATH} "export PUBLISH_FILE_PATH=${PUBLISH_FILE_PATH}"
